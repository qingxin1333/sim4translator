...
一个基于Java的XML文件翻译工具，支持批量翻译XML文件中的文本内容，并提供多种翻译服务选择。

## 功能特性

- 🌐 **多翻译服务支持**: 支持Google翻译、百度翻译、有道翻译
...
### 翻译服务
- **GoogleTranslator**: Google翻译API集成
- **BaiduTranslator**: 百度翻译API集成  
- **YoudaoTranslator**: 有道翻译API集成
